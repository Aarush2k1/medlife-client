...
async function fetchdata(){
  const url='http://localhost:3003/user/fetchCities';
...
async function fetchMed(e){
    ...
    setErrCity('');
    setCty(e);
    const url='http://localhost:3003/user/fetchMed/'+e;
    await axios.get(url).then((response)=>{
...
async function fetchMedInfo(e){
    if(e==='undefined'){
        ...
        setErrMed('');
        setmedd(e);
        const url='http://localhost:3003/user/fetchMedicine/'+e+'/'+cty;
        await axios.get(url).then((response)=>{
...
async function fetchSup(e){
    const url='http://localhost:3003/user/fetchSupplier/'+e;
    await axios.get(url).then((response)=>{
    ...
    <motion.div exit={{opacity:0}} animate={{opacity:1}} initial={{opacity:0}}>
        ...
        <div className="container">
            <center><h1><u>SEARCH MEDICINES</u></h1></center>
            <Row style={{marginTop:'20px'}}>
                ...
                <Row>
                    ...
                    <Form.Control as="select"className='selectdiv' custom onChange={(e)=>{fetchMedInfo(e.target.value)}}>
               ...
               <Row>
                   {
                       Medicine.map((med,index)=>{
                        ...
                        <Card.Text style={{fontWeight:'bold',textAlign:"left"}}>
