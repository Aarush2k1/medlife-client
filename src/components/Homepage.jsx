...
function Homepage(){
    ...
    async function OtpUserInfo(){
        ...
        if(EmailChk&&PasswordChk){
          setRegister(true);
          const url='https://medlife-server.herokuapp.com/nodemailer/'+userInfo.RegEmail;
      ...
      async function subUserInfo(){
        ...
        if(Otp===ResOtp){
          const url='https://medlife-server.herokuapp.com/user';
    ...
    return(
        ...
        <Row>
            ...
            <Col md={4} className="quote_conatiner">
