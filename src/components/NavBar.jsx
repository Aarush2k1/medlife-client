...
function NavBar(){
  ...
  async function subLoginInfo(){
    let EmailChk=true;
        ...
        const url='https://medlife-server.herokuapp.com/login/'+LoginObj.RegEmail+'/'+LoginObj.password;
  ...
  async function nodemailer(){
    ...
    EmailChk=regEx_Email.test(LoginObj.RegEmail);
    if(EmailChk){
      const url='https://medlife-server.herokuapp.com/nodemailer/'+LoginObj.RegEmail;
      await axios.get(url).then((response)=>{
  ...
  async function Changepassword(){
    ...
    if(PasswordChk){
      if(Newpsswrd.NewPassword===Newpsswrd.ConfirmNewPassword){
        const url='https://medlife-server.herokuapp.com/updatePassword/'+LoginObj.RegEmail+'/'+Newpsswrd.NewPassword;
        await axios.get(url).then((response)=>{
