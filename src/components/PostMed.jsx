...
function PostMed(){
    ...
    <motion.div exit={{opacity:0}} animate={{opacity:1}} initial={{opacity:0}}>
        ...
        <div className="container">
            <center><h1><u>MEDICINE DETAILS</u></h1></center>
            <Row>
                <Col md={7}>
                <Row>
                    <Col md={12}>
                ...
                <Col md={5}>
                   <center> <Row>
                        <Col md={12}>
                        <center><span style={{color:"green"}}>FRONT VIEW</span></center>
                        ...
                        <Row>
                            <Col md={12}>
                            <center><span style={{color:"green"}}>REAR VIEW</span></center>
